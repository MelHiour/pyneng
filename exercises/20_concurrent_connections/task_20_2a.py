...
def send_commands_thread(devices, limit = 2, show = False, filename = False, config = False):
    result = {}
...
if __name__ == '__main__':
    ...
    desired = send_commands_thread(devices['routers'], limit = 10, show = 'sh ip int br')
    pprint(desired)
